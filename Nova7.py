...
class MemoryManager:
    ...
    def check_memory(self):
        ...
        try:
            ...
            gc.collect()  # psutil not available, just run GC
        except Exception:
            pass
...
def run_async_workers():
    """Run semua async workers dalam SATU event loop — jimat memory."""
    ...
    try:
        ...
        logger.error(f"Async workers error: {e}")
    finally:
        loop.close()
def run_flask():
...
if __name__ == "__main__":
    ...
    if render_url:
        ...
        # Background threads — SATU event loop untuk semua async workers
