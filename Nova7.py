...
def dispatch_signal(symbol, price, sig, ind, engine_type, daily_note,
    ...
    # Jika htf_block_on_bear=1: block signal bila 1D+4H kedua-dua bearish.
    # Default 0 (warn sahaja). Set 1 semasa bear market untuk elak counter-trend.
    # Tunable: /tune custom htf_block_on_bear=1
    # REENTRY dan SWEEP dikecualikan — mereka ada reversal confirmation sendiri.
