...
class AccumulationDetective:
    ...
    def check(self, ind, t):
        ...
        rvol_min = t.get('acc_rvol', 0.8)   # 0.8 = floor, bukan spike requirement
        ...
        # NOTE: Candle Hijau dibuang dari hard gate — 50% masa candle merah,
        # memblock terlalu banyak peluang. Dijadikan soft hint seperti Higher Low.
        hard_conditions = {
        ...
        # SOFT hints — tunjuk dalam diagnostic tapi tidak block signal
        green_hint = "✓" if is_green else "–"
        hard_conditions[f"Candle Hijau (Soft {green_hint})"] = True
...
async def _layer2_sniper_impl(symbol, scan_type, force, chat_id, user_cap, user_risk):
    ...
    async with aiohttp.ClientSession() as session:
        ...
        if sig:
            ...
            log_activity(f"{symbol} ✅ VALID ({scan_type}) → SENDING...")
