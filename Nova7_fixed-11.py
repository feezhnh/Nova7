...
def dispatch_signal(symbol, price, sig, ind, engine_type, daily_note,
    ...
    # Jika harga dalam ±2% dari $1.00 DAN BB sangat ketat (< 0.5%)
    # = kemungkinan besar stablecoin yang tidak dikenali dalam KILL_LIST
    ...
    # TP1 < 1.5% dari entry = trade tidak bermakna untuk crypto
    # (fee + spread makan untung, contoh: UUSDT TP1 hanya +0.8%)
    ...
    while True:
        ...
        for t in trades:
            ...
            if price <= t['sl'] and status not in ['STOP_LOSS', 'COMPLETED']:
                ...
                record_exit = True
                # Semak peluang re-entry di OB/FVG bawah SL
